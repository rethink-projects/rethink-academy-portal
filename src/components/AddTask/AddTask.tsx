      ...
      <div>
        {active && (
          ...
          <header className={styled.header}>
                <button className={styled.button} onClick={() => setActive(!active)}>
                  <img src={Images.icons.trashIcon} alt="trash icon" />
                </button>
              </header><div className={styled.taskName}>
                  ...
                  <InputText
                    ...
                    value={""} />
                </div><div className={styled.taskData}>
                  <p>Data</p>
                  <DatePicker
                    size={"default"}
                    calendarPosition={"left"}
                    placeholder={"Adicione uma Data"} />
                </div><div className={styled.taskTime}>
                  <p>Hora</p>
                ...
                </div><div className={styled.taskTags}>
                  <p>Tags</p>
                ...
                </div><div className={styled.taskStatus}>
                  <p>Status</p>
                  <div className={styled.label}>
                    <Tag
                      size={"micro"}
                ...
                </div><div className={styled.taskDescription}>
                  <p>Descrição</p>
                  <InputText
                    type={"large"}
                    placeholder={"Placeholder"}
