...
const DropdownSideModal = ({ studentEmail }: prospType) => {
  ...
  }, [userByEmail, user, deleteGoalList, updateGoalList, createGoalList]);
  ...
  if (goals.length > 0) {
    return (
      <div>
        ...
        <div className={styles.dropdown_container_extern}>
            ...
            >
              <div className={styles.dropdown_header}>
                ...
                <div className={styles.dropdown_header_icons}>
                  {goal.isOpen && user.role === "AMBASSADOR" && (
                    <div className={styles.dropdown_header_icons_open}>
                      ...
                      {goal.isDeleteMode && (
                        <div className={styles.delete_modal_container}>
                          ...
                          <button
                            onClick={() => deleteStudentGoalList(goal.id)}
                          >
                            Excluir
                          </button>
                        </div>
              ...
              >
                <div className={styles.dropdown_content_progress}>
                  <div className={styles.dropdown_content_quantity}>
                    <p>
                      {
                        goal.goal.filter((item) => item.conclude === true)
                          .length
                      }
                    </p>
                        ...
                        {user.role === "AMBASSADOR" && (
                          <div>
                            ...
                            {goal.isUpdateGoalMode === goalsIntern.id && (
                              <div
                                className={styles.update_goal_modal_container}
                              >
                                <input
                                  className={styles.modal_input}
                                  placeholder="Digite aqui..."
                            ...
                            {goal.isDeleteGoalMode === goalsIntern.id && (
                              <div
                                className={styles.delete_modal_container_goal}
                              >
                                <div
                                  className={
                                    styles.delete_modal_container_header
                                  }
                                >
                                  <p>
