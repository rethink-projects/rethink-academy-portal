  ...
  return (
    <div className={styles.playground_container}>
      <div className={styles.playground_container_inner}>
        ...
        <div className={styles.scroll_light}>
          <div>
            ...
            readable content of a page when looking t to make a type specimen
            ...
            look even slightly believable. If you are got to make a type
            ...
            of Lorem Ipsum available, but the majority have suffered alteration
            in some form, by injected humour, or randomised words which don't
            look even slightly believable. If you are goat its layout. The point
            ...
            reproduced below for those interested. Sections 1.10.t to make a
            ...
            are go32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero
            are also reproduced in their exact original form, accompanied by
            English versions from the 1914 translation by H. Rackham. Where can
            I get some? There are many variations of passages of Lorem Ipsum
            ...
            injected humour, or non-characteristic words etc. 5 paragraphs words
            bytes lists Start with 'Lorem ipsum dolor sit amet...'
          </div>
        </div>
      </div>
    </div>
